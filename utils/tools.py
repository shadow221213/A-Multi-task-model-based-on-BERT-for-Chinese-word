...
def parse_args_aug( ):
    ...
    parser.add_argument('--roberta_dir', type=str, default='./output/roberta', help='Path to roberta best model checkpoints')
    parser.add_argument('--macbert_dir', type=str, default='./output/macbert', help='Path to macbert best model checkpoints')
    parser.add_argument('--temp_dir', type=str, default='./data/temp', help='Directory to save temp data')
    parser.add_argument('--roberta_model', type=str, default='./models/roberta', help='Path to roberta pretrain model')
    parser.add_argument('--macbert_model', type=str, default='./models/macbert', help='Path to macbert pretrain model')
